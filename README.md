...
```
check your cuda version then install install `torch_scatter` from pre-built wheels
...
For use PACE, please install `environment_linux_PACE.yml` instead of `environment_linux.yml`
