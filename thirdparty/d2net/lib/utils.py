...
def preprocess_image(image: np.ndarray, preprocessing: Optional[str] = None):
    """
    Args:
    ...
    Returns:
        image: array of shape (H,W,3) representing normalized RGB image.
           For 'torch' setting, values are scaled to [0,1], then normalized w/ ImageNet mean and standard dev.
    """
