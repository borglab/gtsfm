...
6. Run gtsfm with `--cluster_config` flag enabled, for example
    - ```
      python /home/username/gtsfm/gtsfm/runner.py --loader colmap_loader --dataset_dir /home/username/gtsfm/skydio-32 --images_dir /home/username/gtsfm/skydio-32/images/ --config_name sift_front_end.yaml --cluster_config cluster.yaml
      ```
