"""Tests for ORB detector-descriptor.
...
class TestORBDetectorDescriptor(test_detector_descriptor_base.TestDetectorDescriptorBase):
    ...
    def setUp(self) -> None:
        ...
        super().setUp()
        self.detector_descriptor = ORBDetectorDescriptor()
