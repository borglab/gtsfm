"""Tests for Colmap's SIFT detector descriptor.
...
from gtsfm.frontend.detector_descriptor.sift_colmap import SIFTColmap


class TestSIFTColmap(test_detector_descriptor_base.TestDetectorDescriptorBase):
    ...
    def setUp(self):
        ...
        super().setUp()
        self.detector_descriptor = SIFTColmap()
