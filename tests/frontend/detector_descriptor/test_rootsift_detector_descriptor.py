"""Tests for RootSIFT detector descriptor
...
class TestRootSIFTDetectorDescriptor(test_detector_descriptor_base.TestDetectorDescriptorBase):
    ...
    def setUp(self):
        ...
        super().setUp()
        self.detector_descriptor = RootSIFTDetectorDescriptor()
