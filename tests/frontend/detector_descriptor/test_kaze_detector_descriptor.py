"""Tests for the KAZE detector descriptor.
...
class TestKAZEDetectorDescriptor(test_detector_descriptor_base.TestDetectorDescriptorBase):
    ...
    def setUp(self) -> None:
        ...
        super().setUp()
        self.detector_descriptor = KAZEDetectorDescriptor()
