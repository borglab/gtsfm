...
def run_bundle_adjustment_from_gt(
    ...
    factor_graph_filename = "factor_graph.txt"
    if factor_graph_output_path is not None:
        factor_graph_filename = Path(factor_graph_output_path).name
    ...
    post_ba_data, final_error = ba.run_simple_ba(gt_init_data, verbose=True)
