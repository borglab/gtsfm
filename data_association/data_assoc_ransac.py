...
class DataAssociation(FeatureTrackGenerator):
    ...
    def __init__(self) -> None:
        """ initilaization of data association """
                
    def run(self, 
        matches: Dict[Tuple[int, int], Tuple[int, int]], 
        feature_list: List[List[np.ndarray]],
        ...
        Args:
            ...
            calibrationFlag: flag to set shared (calibration + global_poses)or individual calibration (camera list)
        ...
        LMI = LandmarkInitialization(calibrationFlag, calibration, global_poses, camera_list)
