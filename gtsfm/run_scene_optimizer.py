...
def run_scene_optimizer_hydra(cfg: DictConfig) -> None:
	...
	scene_optimizer.feature_extractor = instantiate(scene_optimizer.feature_extractor)
	scene_optimizer.feature_extractor.detector_descriptor = instantiate(
		scene_optimizer.feature_extractor.detector_descriptor
	)

	scene_optimizer.two_view_estimator = instantiate(scene_optimizer.two_view_estimator)
	scene_optimizer.two_view_estimator.matcher = instantiate(
		scene_optimizer.two_view_estimator.matcher
	)
	scene_optimizer.two_view_estimator.verifier = instantiate(
		scene_optimizer.two_view_estimator.verifier
	)

	scene_optimizer.multiview_optimizer = instantiate(scene_optimizer.multiview_optimizer)
	scene_optimizer.multiview_optimizer.rot_avg_module = instantiate(
		scene_optimizer.multiview_optimizer.rot_avg_module
	)
	scene_optimizer.multiview_optimizer.trans_avg_module = instantiate(
		scene_optimizer.multiview_optimizer.trans_avg_module
	)
	scene_optimizer.multiview_optimizer.data_association_module = instantiate(
		scene_optimizer.multiview_optimizer.data_association_module
	)

	import pdb
	pdb.set_trace()

	scene_optimizer.multiview_optimizer.data_association_module.mode = instantiate(
