...
class DataAssociation(NamedTuple):
    ...
    def create_computation_graph(
        ...
        Args:
            ...
            gt_cameras: a list of cameras with ground truth params, if they exist.
        ...
        ba_input_graph, data_assoc_metrics_graph = dask.delayed(self.run, nout=2)(
            num_images, cameras, corr_idxs_graph, keypoints_graph, gt_cameras, relative_pose_priors, images_graph
        )
