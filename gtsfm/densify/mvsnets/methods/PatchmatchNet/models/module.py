"""Implementation of PatchmatchNet modules
...
class ConvBnReLU(nn.Module):
    """Implementation of convolution2D + batch normalization + relu module"""
...
class ConvBnReLU3D(nn.Module):
    """Implementation of convolution3D + batch normalization + relu module"""
...
class ConvBnReLU1D(nn.Module):
    """Implementation of convolution1D + batch normalization + relu module"""
...
class ConvBn(nn.Module):
    """Implementation of convolution2D + batch normalization module"""
...
def differentiable_warping(
    ...
    """warping methods for differentiable homography
    Args:
        src_fea: [B, C, H, W] source feature
        src_proj: [B, 4, 4] source camera pose
        ref_proj: [B, 4, 4] reference carmera pose
...
def depth_regression(p: torch.Tensor, depth_values: torch.Tensor):
    """depth regression function
    Args:
...
def depth_regression_1(p: torch.Tensor, depth_values: torch.Tensor):
