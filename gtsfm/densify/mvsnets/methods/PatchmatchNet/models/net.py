...
class Refinement(nn.Module):
    ...
    def forward(
        ...
        """forward methods
        Args:
            img: input source and reference images
            depth_0: current depth map
            depth_min: pre-defined minimum depth
            depth_max: pre-defined maximum depth
        Returns:
            depth: refined depth map
        """
...
def patchmatchnet_loss(depth_patchmatch: Dict, refined_depth: Dict, depth_gt: Dict, mask: Dict):
