...
DOOR_TESTING="./data/door"
CKPT_FILE="./checkpoints/model_000007.ckpt"
python eval_door.py --dataset=door_eval --batch_size=1 --n_views 10 \
...
--testpath=$DOOR_TESTING --geo_pixel_thres=1 --geo_depth_thres=0.01 --photo_thres 0.8 \
--outdir=./outputs/door --testlist lists/dtu/test.txt --loadckpt $CKPT_FILE $@
