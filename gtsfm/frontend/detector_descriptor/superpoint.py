...
MODEL_WEIGHTS_PATH = ROOT_PATH / "thirdparty" / "models" / "superpoint" / "superpoint_v1.pth"


class SuperPointDetDesc(DetectorDescriptorBase):
    """Superpoint Detector+Descriptor implementation."""
    ...
    def detect_and_describe(self, image: Image) -> Tuple[Keypoints, np.ndarray]:
        ...
        with torch.no_grad():
            model_results = model(image_tensor)
