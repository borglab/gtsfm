...
class FeatureExtractor:
    ...
    def create_computation_graph(self, image: Delayed) -> Tuple[Delayed, Delayed]:
        """Given an image, create detection and descriptor generation tasks

        Args:
            image: image wrapped up in Delayed

        Returns:
            Delayed object for detected keypoints.
            Delayed object for corr. descriptors.
        """
        return self.detector_descriptor.create_computation_graph(image)
