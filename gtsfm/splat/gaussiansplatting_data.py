...
from gtsfm.splat.utils import auto_orient_and_center_poses, _undistort_image
...
class GaussianSplattingData(Dataset):
    ...
    def __init__(self, images: Dict[int, Image], sfm_result: GtsfmData) -> None:
        ...
        # self._camera_idx_to_gaussiansplatting_idx = {i: gs_i for gs_i, i in self._gaussiansplatting_idx_to_camera_idx.items()}
    ...
    def _generate_dataparser_outputs_from_gtsfm_data(self, gtsfm_data: GtsfmData, images: List[Image]) -> Dict:
        ...
        return self._process_scene_data(wTi_list, image_filenames, calibrations, point_cloud, rgb)
   
   
    def _process_scene_data(self, wTi_list, image_filenames, calibrations, point_cloud, rgb) -> Dict:
