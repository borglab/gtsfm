...
def getErrorTrifocal(vpts1, vpts2, vpts3, matchedTriplets, Tri: np.ndarray) -> float:
    ...
    Args:
        ...
        Tri: array of shape (3,3,3,) representing trifocal tensor
    """
    ...
    for i in range(len(matchedTriplets,1)):
        ...
        p3 = p3/p3(3)
        error = np.sqrt(sum((p3 - m(1).a3).*(p3 - m(1).a3)))
