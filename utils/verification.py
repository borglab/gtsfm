...
def cast_essential_matrix_to_gtsam(im2_E_im1: np.ndarray,
    ...
    _, R, t, _ = cv.recoverPose(im2_E_im1,
                                camera_intrinsics_im1.calibrate(
                                    verified_coordinates_im1[:, :2]),
                                camera_intrinsics_im2.calibrate(
                                    verified_coordinates_im2[:, :2]))
...
def fundamental_matrix_to_essential_matrix(im2_F_im1: np.ndarray,
    ...
    Args:
        im2_F_im1: fundamental matrix which maps points in image #1 to lines in 
                   image #2. 
        camera_intrinsics_im1 (Cal3Bundler): intrinsics for image #1.
        camera_intrinsics_im2 (Cal3Bundler): intrinsics for image #2.
